                ...
                if ($length !== $client->toRead) {
                    ...
                    if ($decoded === false) {
                        ...
                        if ($event instanceof AddUserDataEvent) {
                            ...
                            $event->packet->decode(); // workaround for incomplete php classes after un-serializing TODO
                            ...
                            if ($event->extraData["bedrockKnownStates"]) {
                                ...
                                if (is_null($property)) {
                                    ...
                                    GlobalItemTypeDictionary::setInstance(unserialize($event->extraData["itemDictionary"]));
