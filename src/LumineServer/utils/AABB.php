...
class AABB extends AxisAlignedBB {
    ...
    public static function from(UserData $data): self {
        $pos = $data->currentPos;
    ...
    public static function fromBlock(Block $block): AABB {
        ...
        if ($b !== null) {
            ...
            $p = $block->getPosition();
            return new AABB($p->x, $p->y, $p->z, $p->x + 1, $p->y + 1, $p->z + 1);
        }
    }
    ...
    public function calculateIntercept(Vector3 $pos1, Vector3 $pos2): ?RayTraceResult {
        return $this->isVectorInside($pos1) ? new RayTraceResult($this, 0, new Vector3(0, 0, 0)) : parent::calculateIntercept($pos1, $pos2);
    }
